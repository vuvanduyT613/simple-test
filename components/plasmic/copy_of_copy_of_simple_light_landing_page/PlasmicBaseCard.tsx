...
import * as sty from "./PlasmicBaseCard.module.css"; // plasmic-import: hEoCMQOgk0_MmF/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(defaultcss.all, sty.box__npEu3, {
          [sty.box__long__npEu3DExAh]: hasVariant(variants, "long", "long")
        })}
      >
        <p.PlasmicSlot
          defaultContents={
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.box__xNx9L, {
            [sty.box__long__xNx9LDExAh]: hasVariant(variants, "long", "long")
          })}
        >
          <p.PlasmicSlot
            defaultContents={
              <svg
                className={classNames(defaultcss.all, sty.svg__iYjt3)}
                role={"img"}
              />
            }
            value={args.iconBack}
