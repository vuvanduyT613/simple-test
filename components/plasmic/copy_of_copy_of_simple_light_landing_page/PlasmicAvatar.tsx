...
import * as sty from "./PlasmicAvatar.module.css"; // plasmic-import: MU7IJjbB7TF4Yb/css
    ...
    >
      <p.PlasmicSlot
        defaultContents={
          <img
            alt={""}
            className={classNames(defaultcss.img, sty.img__w3BUd)}
            role={"img"}
            src={
