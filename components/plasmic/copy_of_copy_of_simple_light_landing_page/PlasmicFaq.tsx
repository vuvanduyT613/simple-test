...
import * as sty from "./PlasmicFaq.module.css"; // plasmic-import: D48S00s9NuUnYA/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__ypGY)}
      >
        <div className={classNames(defaultcss.all, sty.box__mkrDd)}>
          <div className={classNames(defaultcss.all, sty.box__gdf1G)}>
            <p.PlasmicSlot
